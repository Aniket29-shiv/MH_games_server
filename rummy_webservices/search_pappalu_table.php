...
$seluser = "SELECT * FROM player_table WHERE game_type = '$gameType'  AND min_entry = '$point' AND min_entry = '$point' AND player_capacity = '$noOfPlayer' AND game = '$game' AND table_status = 'L'";
...
// 	$userdata = mysqli_fetch_array($runuser);
	...
	else
	{
		...
		$sqltable = "insert into player_table(table_name,game_type,point_value,min_entry,status,player_capacity,game,table_type,pool,table_no,creared_on,joker_type,table_status) VALUES ('Deal Game','".$gameType."','0','".$point."','process','".$noOfPlayer."','".$game."','".$table_type."','0','".$table_no."','".$today."','Joker','L')";
