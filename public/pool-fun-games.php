...
$sql_table= "SELECT * FROM `player_table` WHERE game = 'Free Game' and `game_type` = 'Pool Rummy' and `table_status` = 'L' group by min_entry,player_capacity,pool order by min_entry ASC";
...
<p id="emptytablemsg" style="color: white; background: green; width: 50%; margin: auto; padding: 10px;display:none;">
    ...
    background: -webkit-linear-gradient(#9b57f0, #4f2f77)" id="101"name="101" value="101" >101 Pools</button>
                  <button type="button" class="btn " onclick="check_but2(this.value);" value="201" style=" margin-top: 5px;color: #fff;
    background: -webkit-linear-gradient(#9b57f0, #4f2f77)" id="201" name="201">201 Pools </button>
                ...
                <input type="hidden" id="selpool" value="101">	<a id="join" target="" onclick="join('<?php echo $loggeduser;?>')"><button  style=" margin-top: 5px;color: #fff;
							...
							<table class="table table-bordered table-striped table-condensed">
								...
								$pool='';
									...
									<tr>
										...
										<td><?php echo $player_capacity;?></td>
										<td><?php echo  $a; ?></td>
										<td>
					...
					<?php include 'takeseat.php';?>
						<div class="dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								<li><a href="#" class="over-hid">101 Pool</a></li><hr class="mt0 mb0">
								<li><a href="#">201 Pool</a></li><hr class="mt0 mb0">
							</ul>
						</div>
						<div class="dropdown">
							<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
  ...
  var a="#6_Players";
   ...
   var pool=$("#selpool").val();;
         var dataString ='getpoolvaluefree='+pointval+'&poolvalue='+pool;
...
function timingLoad() {
    ...
    var hide = $("#hide").val();
    var logid = $("#logid").val();
    var dataString ='funpoolplayers='+players+'&game='+game+'&bet='+bet+'&hide='+hide+'&logid='+logid;
    //  alert(dataString);
    $.ajax({
    ...
    //$('section').load('pool-fun-games.php section', function() {
