...
// 	$userdata = mysqli_fetch_array($runuser);
	...
	else
	{
		...
		$sqltable = "insert into player_table(table_name,game_type,point_value,min_entry,status,player_capacity,game,table_type,pool,table_no,creared_on,joker_type,table_status) VALUES ('Papplu Game','".$gameType."','0','".$point."','process','".$noOfPlayer."','".$game."','".$table_type."','0','".$table_no."','".$today."','Joker','L')";
