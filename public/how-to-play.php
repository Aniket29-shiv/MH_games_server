	...
	<main>
		<div class="container-fluid pa0 mt20">
			<div class="container play-cont-wrapper">
				...
				<div class="row mt35 mlr0 black-bg">
					<div class="col-md-8 col-sm-9">
						<h3 class="text-center color-white"><i>Register and play rummy game online with friends & family and win real cash prices</i></h3>
					</div>
					<div class="col-md-4 col-sm-3 text-center">
						<a href="registration.php"><button class="btn btn-default">Register Now !</button></a>
					</div>
				</div>
				<hr class="mt25">
			</div>
