...
require ("database.php");
            ...
            $file_type = pathinfo($targetFilePath,PATHINFO_EXTENSION);
                if(in_array($file_type, $allow_types)){    
                    ...
                    if(move_uploaded_file($_FILES['images']['tmp_name'][$key],$targetFilePath)){
            	     ...
            	     $makequery="INSERT INTO `user_help_reply`(`ticketid`, `msg`,`type`,  `created_date`,`reply_by`) VALUES ('$ticketid','',1,'$cdate','$loggeduser')";
    ...
    if($msg != ''){
	     ...
	     $updateequery="UPDATE `user_help_support` SET `lastreply`='User' WHERE id='$ticketid'";
	     mysqli_query($conn,$updateequery);
	     $makequery="INSERT INTO `user_help_reply`(`ticketid`, `msg`,  `created_date`,`reply_by`) VALUES ('$ticketid','$msg','$cdate','$loggeduser')";
