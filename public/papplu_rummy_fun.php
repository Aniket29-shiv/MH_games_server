...
$sql_table= "SELECT * FROM `player_table` WHERE game = 'Free Game' and `game_type` = 'papplu Rummy' and `table_status` = 'L' group by min_entry,player_capacity order by min_entry ASC";
...
<p id="emptytablemsg" style="color: white; background: green; width: 50%; margin: auto; padding: 10px;display:none;">
    ...
    background: -webkit-linear-gradient(#4d0000, #4d0000)" id="2_Players"name="2 Players" value="2" >2 </button>
                  <button type="button" class="btn " onclick="check_but(this.value);" value="6" style=" margin-top: 5px;color: #fff;
    background: -webkit-linear-gradient(#4d0000, #4d0000)" id="6_Players" name="6 Players">6 </button>
    ...
    background: -webkit-linear-gradient(#4d0000, #4d0000)">  	<i  class="glyphicon glyphicon-minus"  onclick="minus();" title="" style="color:white;"></i></button>
                 ...
                 <button class="btn " style=" margin-top: 5px;height: 34px;color: #fff;
    background: -webkit-linear-gradient(#4d0000, #4d0000)">	<i  class="glyphicon glyphicon-plus" title=""  onclick="plus();"style="color:white;"></i></button>
                </div>
                 &nbsp;&nbsp;&nbsp;
                <div class="btn-group" role="group">
    ...
    background: -webkit-linear-gradient(#4d0000, #4d0000)"class="btn ">Join</button></a>
				</div>
							...
							<table class="table table-bordered table-striped table-condensed">
								...
								<?php
									...
									while($table = $result_table->fetch_assoc())
									{
									    ...
									    $sql1="select * from  user_tabel_join where `game_type` = 'Papplu Rummy' and chip_type='free' and player_capacity=".$player_capacity." AND min_entry=".$min_entry."  ";											
...
function check_but(a){
      ...
      var dataString ='getpappluvaluefree='+pointval;
...
function check_table(user,player_capacity,min_entry,game_type,game){
    ...
    console.log(user);
    console.log(player_capacity);
    console.log(min_entry);
    ...
    var players = $("#players").val();
     	...
     	var hide = $("#hide").val();
          ...
          var dataString ='freepappluplayers='+players+'&min='+min+'&max='+max+'&hide='+hide+'&logid='+logid;
           // alert(dataString);
            $.ajax({
