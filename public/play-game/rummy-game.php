...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<img src="images/storerummy-main-bg.png" width="100%" height="100%" alt="" style="position:absolute; top:0; z-index:-1">
	
	<!-- top menu start -->
	<div class="top-left-menu">
		<ul>
			<li><a href="#" class="openInfo">Game Info</a></li>&nbsp;
			<li><a href="../buy-chips.php">Buy Chips</a></li>
		</ul>
		<ul style="float:right">
			<li><a href="../point-lobby-rummy.php">Lobby</a></li>&nbsp;
			<li><a href="../account-contact-us.php">Help</a></li>&nbsp;
			<li><a href="rummy-game.php">Refresh</a></li>&nbsp;
	...
	<!-- top sit here button -->
	<div class="top-chair">
		<div class="front-chair"><img src="images/chair-4.png"/></div>
		...
		<div class="front-dealer"><img src="images/dealer-icon.png"></div>
	</div>
	<!-- top sit here button -->
	...
	<div class="table-popup">
		...
		<div>
			<img src="images/buyinwindow-ok-btn.png" class="btn-ok">
			<img src="images/repoart-prob-cancel-btn.png" class="btn-cancel">
		</div>
	</div>
	<!-- table pop-up -->
	...
	<div class="table-content-wrapper">
		<div class="joker-card dis-ib">
			<img src="images/single-aces.png"/>
		</div>
	...
	<div class="content-buttons">
		...
		<div class="discard-but">
			<img src="images/discard-btn.png">
		</div>
		...
		<table class="table-bordered">
			<tbody>
				...
				<tr style="text-align:center">
					<td>John Doe</td>
					<td><img src="images/winner-rummy.png" style="width:55%"></td>
				...
				<tr style="text-align:center">
					<td>John Doe</td>
					<td><img src="images/winner-rummy.jpg" style="width:40%"></td>
				...
				<tr class="joker" style="text-align:center">
					<td>Joker</td>
					<td><img src="images/single-aces.png"></td>
	...
	<div class="bottom-chair">
		<div class="bott-chair"><img src="images/chair-1.png"/></div>
		<!-- <div class="bott-female"><img src="images/female-1.png"/></div> -->
		<!--<div class="bott-male"><img src="images/male-1.png"/></div> -->
		 <div class="bott-sit"><img src="images/sithere_btn.png" class="sit-popup"></div>
		<div class="bot-dealer"><img src="images/dealer-icon.png"></div>
	...
	<div class="sort-drop-but">
		<div class="sort-but">
			<img src="images/sortbtn.png"/>
		</div>
		<div class="drop-but">
			<img src="images/Dropbtn.png"/>
		</div>
	</div>
	<!-- sort drop button -->
