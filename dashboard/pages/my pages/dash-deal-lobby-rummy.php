<?php 
	include('lock.php'); 
	include('config.php'); 
	include('include/rummy-dash-deal-lobby.php');
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box-footer with-border" style="text-align:right;">
						    ...
						    <a href="dash-deal-lobby-rummy.php" class="btn btn-danger">Cancel</a>
						</div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Cash Deal Rummy List ( Total Records : <?php echo numberofdata($conn,$joker,$players,$bet,$status);?>)</h3>
								    </div>
									...
									<!--	<tr>
											...
											<td>-->
												...
												<!--	<a href="#"> 
													...
													<a href="table_action.php?live=<?php //echo $row['table_id']; ?>&page=dash-deal-lobby-rummy.php">
													<button class="btn btn-success">Live</button>
												</a>-->
												<?php //}else{ ?>
											<!--	<a href="table_action.php?stop=<?php //echo $row['table_id']; ?>&page=dash-deal-lobby-rummy.php"> 
