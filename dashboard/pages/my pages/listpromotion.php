<?php 
	...
	include('lock.php'); 
	include('config.php');
	include('include/promotionlist.php');
				...
				<div class="row">
					<div class="col-xs-12">
					    <div class="box-header with-border">
								<h3 class="box-title">Promotions List</h3><a href="addpromotion.php" class="btn btn-primary" style="margin-left:10px;">Add Promotion</a>
							</div>
