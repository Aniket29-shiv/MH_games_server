				...
				<section class="content">
					<div class="row">
						...
						<div class="col-md-4  col-xs-12">
									...
									<form role="form"  method="post" enctype="multipart/form-data">
										<div class="box-body">
											...
											<div class="form-group">
												<label >Image (<span style="color:blue;"> Dimension Must Be 300*100 </span>)</label>
									 ...
									 <div class="box-footer" style="text-align: right;">
											...
											<p style="text-align: left; color: #ff002d;">Note : Only png file upload</p>
										</div>			
									
									  <?php  if($status==1){ ?>
                                        
                                        <div class="alert alert-success alert-dismissable fade in" style="padding: 6px; width:100%;">
                                        ...
                                        <div class="alert alert-danger alert-dismissable fade in" style="padding: 6px; width:100%;">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							...
							<div class="box">
								<!-- /.box-header -->
								<div class="box-body" style="border: 3px solid; border-color: #eef3b4;">
								
										<div class="box-body">
										
                                      <div class="col-md-12 col-xs-12">	
											<div class="form-group">
											<img src="http://rummysahara.com/images/logo.png" style="width:100%;">
											</div>
											</div>
