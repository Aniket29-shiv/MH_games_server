...
$makequery="select * from player_table where game='Free Game' AND game_type='Point Rummy' ";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Cash-Point-Free-Rummy');
...
header('Content-Disposition: attachment;filename="Cash-Point-Free-Rummy-'.$cdate.'.xls"');
