<?php 
	include ('lock.php');
	include ('config.php');
		include('include/transaction_player.php');
					...
					<div class="col-xs-12">
						    ...
						    <div class="col-md-2 col-xs-12">
						   	...
						   	<div class="dropdown">
						   	    ...
						   	    <select class="btn btn-primary" name="game">
						   	        ...
						   	        <option value="Papplu Rummy">Papplu Rummy</option>
                        ...
                        <div class="col-md-2 col-xs-12">
                         ...
                         <div class="col-xs-1">
                        	...
                        	<a href="player_transaction.php" style="margin-top:16px;"   class="btn btn-danger">Cancel</a></div>
							...
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        ...
								        <span style="color:green;">Total Won Amount : </span><span>Rs. <?php echo number_format(totalwin($conn,$game,$players,$from,$to,$chiptype,$status),2);?>/-</span>
								        </div>
								         <div class="col-md-6" style="background: #d8c6af; padding: 5px; width: 49%; font-size: 18px;margin: 1px;">
								        <span style="color:red;">Total Lost Amount : </span><span>Rs. <?php echo number_format(totallost($conn,$game,$players,$from,$to,$chiptype,$status),2);?>/-</span>
								         </div>
								         </div>
								        
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-player_transaction.php">
