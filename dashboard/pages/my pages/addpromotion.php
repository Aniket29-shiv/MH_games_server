<?php
	include('lock.php');
	include("config.php");
	include('include/promotionadd.php');
	$status = '';
	if($_GET){
	  $status = $_GET['status'];
	}
					...
					<div class="row">
						...
						<div class="col-md-12  col-xs-12">
							<div class="box-header with-border">
								<h3 class="box-title">Add Promotions</h3><a href="listpromotion.php" class="btn btn-primary" style="margin-left:10px;">Promotions List</a>
							</div>
							<div class="box">
								<!-- /.box-header -->
								<div class="box-body">
									<form role="form"  method="post" enctype="multipart/form-data">
										...
										<div class="col-md-12 col-xs-12">	
                                      	<div class="form-group">
											...
											<div class="col-md-12 col-xs-12">	
                                      	<div class="form-group">
												<label class="col-xs-12" style="width:100%">Short Description (<span style="color:blue">100 Characters Allowed Only</span>)</label><br />
												<input type="text" name="shortdescription" value="<?php echo $shortdescription;?>" maxlength="100" required  style="padding:5px 0px; width:100%">
											</div>
											</div>
											<div class="col-md-12 col-xs-12">	
                                      	<div class="form-group">
												<label style="width:30%">Description</label><br />
											<textarea class="form-control textarea"  required name="description"><?php echo $description;?></textarea>
											</div>
											</div>
                                         <div class="col-md-6 col-xs-12">	
											...
											<div class="form-group">
												...
												<?php if($simage != ''){ echo '<img src="'.$path.''.$simage.'" style="width: 50%;">';}?>
											</div>
											</div>
