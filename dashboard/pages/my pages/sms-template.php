<?php
	...
	include('lock.php');
	include("config.php");
	include('include/smstemp-add.php');
	$status = '';
	if($_GET){
	  $status = $_GET['status'];
	}
								...
								<div class="box-body">
									<form role="form"  method="post" enctype="multipart/form-data">
										...
										<div class="box-body">
                                            ...
                                            <textarea class="form-control"  required name="emessage"><?php echo $emessage;?></textarea>
                                            </div>
                                            </div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">SMS Template List ( Total Records : <?php echo numberofdata($conn);?>)</h3>
								    </div>
