<?php 
	...
	include('lock.php'); 
	include('config.php');
	include('include/rummy-dash-point-lobby.php');
	

	//$query = "select * from player_table where game='Cash Game' AND game_type='Point Rummy' ORDER BY table_id DESC";
			...
			<section class="content">
				...
				<div class="row">
					<div class="col-md-12 col-xs-12">
						...
						<div class="box-footer with-border col-md-12 col-xs-12" style="text-align:right;">
							<input type="submit" class="btn btn-primary" name="search" value="Search">
						    <a href="dash-point-lobby-rummy.php" class="btn btn-danger">Cancel</a>
						</div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Cash Point Rummy List ( Total Records : <?php echo numberofdata($conn,$joker,$players,$bet,$status);?>)</h3>
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-dash-point-lobby-rummy.php">
