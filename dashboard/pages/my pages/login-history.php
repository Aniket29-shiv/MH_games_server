...
include 'lock.php'; 
include 'config.php';
	include('include/history-login.php');
error_reporting(0);
							...
							<hr style="border:0.5px solid; margin-top: 0px;">
                                        ...
                                        <form method="get">
                                            ...
                                            <div class="col-md-3 col-xs-12">
                                                ...
                                                <a href="login-history.php" class="btn btn-danger"  style="margin-top: 19px;">Cancel</a>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">User Login History ( Total Records : <?php echo numberofdata($conn,$searchval,$from,$to);?>)</h3>
								    </div>
