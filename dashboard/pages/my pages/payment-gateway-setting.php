...
//error_reporting(E_ALL);
	include('lock.php');
	include("config.php");
	include('include/payment-gateway.php');
			...
			<section class="content">
				<div class="row">
					<div class="box-header text-center with-border">
						<h3 class="box-title">Payment Gateway Configuration</h3>
					</div>
					<div class="col-md-6  col-xs-12">
						<div class="box">
							<div class="box-header text-center with-border">
					      	<h3 class="box-title">Payment Gateway Cash Free Configuration</h3>
				         	</div>
							<div class="box-body">
							<form method="post">
								<div style="padding:20px 5%">
								    
								<label style="width:40%; display:none;" >Payment Gateway Name :</label>
								<input type="text" style="width:56%; display:none;" name="pgname" value="<?php echo $pgname;?>">  
                                
                                <label style="width:40%">Client ID :</label>
                                <input type="text" style="width:56%" name="pgid" required value="<?php echo $pgid;?>">
                                
                                <label style="width:40%;margin-top:20px">Client Secrate Key :</label>
                                <input type="text" style="width:56%" name="pgkey" required value="<?php echo $pgkey;?>">
                                
                                <label style="width:40%">Mode:</label>   
                                <select required style="width:56%" name="pgtype">
                                 <option value="">Select Mode</option>
                                 <option value="PROD" <?php if($pgtype == 'PROD'){ echo 'selected="selected"';} ?>>Live</option>
                                 <option value="TEST" <?php if($pgtype == 'TEST'){ echo 'selected="selected"';} ?>>Testing</option>
                                </select>
								...
								<div style="padding:20px 5%;margin:0px 15px" class="text-right">
									<input type="submit" name="cashfree"  class="btn btn-info" value="Submit">
								</div>
					...
					<div class="col-md-6  col-xs-12">
						<div class="box">
							<div class="box-header text-center with-border">
					      	<h3 class="box-title">Payment Gateway Paytm Configuration</h3>
				         	</div>
							<div class="box-body">
							...
							<form method="post">
								<div style="padding:20px 5%">
								 <label style="width:40%;display:none;">Payment Gateway Name :</label>
                                <input type="text" style="width:56%;display:none;" name="pgname1" value="<?php echo $pgname1;?>">  
                                
                                <label style="width:40%">Merchant ID :</label>
                                <input type="text" required style="width:56%" name="pgid1" value="<?php echo $pgid1;?>">
                                
                                <label style="width:40%;margin-top:20px">Merchant Key :</label>
                                <input type="text" required style="width:56%" name="pgkey1" value="<?php echo $pgkey1;?>">
                                
                                <label style="width:40%">Mode:</label>   
                                <select required  style="width:56%" name="pgtype1">
                                 <option value="">Select Mode</option>
                                 <option value="PROD" <?php if($pgtype1 == 'PROD'){ echo 'selected="selected"';} ?>>Live</option>
                                 <option value="TEST" <?php if($pgtype1 == 'TEST'){ echo 'selected="selected"';} ?>>Testing</option>
                                </select>
								...
								<div style="padding:20px 5%;margin:0px 15px" class="text-right">
									<input type="submit" name="Paytm"  class="btn btn-info" value="Submit">
								</div>
								 <?php if($message2 != ''){?>
