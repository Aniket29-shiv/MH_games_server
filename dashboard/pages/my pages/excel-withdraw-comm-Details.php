...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('F1', 'REQUEST AMOUNT')
...
while($row = mysqli_fetch_array($result))
{
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('H'.$i, $reqdate);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Withdrawl-Details');
...
header('Content-Disposition: attachment;filename="Withdrawl-Details'.$cdate.'.xls"');
