<?php 
	include('lock.php'); 
	include('config.php'); 
	include('include/rummy-papplu-lobby.php');
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="box-footer with-border" style="text-align:right;">
						    ...
						    <a href="papplu-lobby-rummy" class="btn btn-danger">Cancel</a>
						</div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Cash Papplu Rummy List ( Total Records : <?php echo numberofdata($conn,$joker,$players,$bet,$status);?>)</h3>
								    </div>
