<?php 
	include ('lock.php');
	include ('config.php');
	include('include/listemailtoplayer.php');
		...
		<div class="content-wrapper">
			...
			<section class="content">
			    <div class="box-header with-border">
								<h3 class="box-title">Send New Email</h3><a href="email-to-player.php" class="btn btn-primary" style="margin-left:10px;">Send Email</a>
							</div>
				<div class="row">
					<div class="col-xs-12">
                                        ...
                                        <form method="get">
                                          <div class="col-md-3 col-xs-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <a href="emailtoplayerlist.php" class="btn btn-danger"  style="margin-top: 19px;">Cancel</a>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Players Mail List ( Total Records : <?php echo numberofdata($conn,$searchval,$from,$to);?>)</h3>
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-player-mail.php">
