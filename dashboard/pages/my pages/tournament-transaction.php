<?php 
	include ('lock.php');
	include ('config.php');
	include ('include/transaction-tournament.php');
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
						    <div class="box-header with-border">
								<h3 class="box-title">Tournament Detail </h3><button onclick="goBack()" class="btn btn-primary" style="margin-left:10px;">Go Back</button>
							</div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Tournament Transaction Details ( Total Records : <?php echo  numberofdata($conn,$tid).' / '.$players;?>)</h3>
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-tournament-tran-Details.php">
