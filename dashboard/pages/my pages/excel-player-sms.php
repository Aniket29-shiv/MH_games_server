...
while($row = mysqli_fetch_array($result))
{
	...
	$objPHPExcel->getActiveSheet()->setCellValue('D'.$i, $mobileno);
	$objPHPExcel->getActiveSheet()->setCellValue('E'.$i, $username);
	$objPHPExcel->getActiveSheet()->setCellValue('F'.$i, $message);
	$objPHPExcel->getActiveSheet()->setCellValue('G'.$i, $response);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Players-SMS-Details');
...
$objPHPExcel->getActiveSheet()->getStyle('A1:G1')->getFont()->setName('Candara');
...
$objPHPExcel->getActiveSheet()->getStyle('A1:G1')->getFill()->getStartColor()->setARGB('FF1E4580');
...
header('Content-Disposition: attachment;filename="Players-SMS-Details-'.$cdate.'.xls"');
