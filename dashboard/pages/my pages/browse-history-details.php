...
include 'lock.php'; 
include 'config.php';
	include('include/history-browse-details.php');
error_reporting(0);
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
						    <div class="box-header with-border">
								<h3 class="box-title">Search <a href="browse-history.php" class="btn btn-primary" style="margin-left:10px;">Back</a> </h3>
							</div>
							<hr style="border:0.5px solid; margin-top: 0px;">
                                        ...
                                        <form method="get">
                                            ...
                                            <div class="col-md-3 col-xs-12">
                                                ...
                                                <a href="browse-history-details.php?userid=<?php echo $searchval;?>" class="btn btn-danger"  style="margin-top: 19px;">Cancel</a>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Browse History Details Of - <span style="font-weight: 800;color: #0e5aea;"><?php echo strtoupper( $fname.' '.$lname);?></span>( Total Records : <?php echo numberofdata($conn,$searchval,$from,$to);?>)</h3>
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-browse-history-Details.php">
									...
									<table class="table table-bordered table-hover  table-striped">
										<thead>
										   	...
										   	<tr>
												...
												<th style="text-align:center">Browse URL</th>
