...
include 'lock.php'; 
include 'config.php';
	include('include/withdraw-request.php');
error_reporting(0);
							...
							<hr style="border:0.5px solid; margin-top: 0px;">
                                        ...
                                        <form method="get">
                                            ...
                                            <div class="col-md-3 col-xs-12">
                                                ...
                                                <a href="withdrawal-request.php" class="btn btn-danger"  style="margin-top: 19px;">Cancel</a>
							...
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
								     ...
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-withdraw-Details.php">
