<?php 
	...
	include('lock.php'); 
	include('config.php');
	include('include/bannerlist.php');
				...
				<div class="row">
					<div class="col-xs-12">
					    <div class="box-header with-border">
								<h3 class="box-title">Banners List</h3><a href="addbanner.php" class="btn btn-primary" style="margin-left:10px;">Add Banner</a>
							</div>
...
$(function(){
	     ...
	     $('#stop'+proid).show();
          ...
          var dataString ='updatebannerstatus='+proid;
              //  alert(dataString);
                $.ajax({
