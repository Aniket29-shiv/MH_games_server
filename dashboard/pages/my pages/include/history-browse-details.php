    ...
    if(mysqli_num_rows(	$query) > 0){     
    	...
    	while($listdata=mysqli_fetch_object($query)){
                ...
                <td>'.$listdata->username.'</td>
                 ...
                 <td>
                 <form action="'.MAINLINK.'public/login-admin.php" method="post" target="_blank">
                 <input type="hidden" name="username" value="'.$listdata->username.'">
                 <input type="hidden" name="url" value="'.$listdata->browse_url.'">

                 <input type="submit" style="background: white; border: none; color: blue;" name="submit" value="'.$listdata->browse_url.'">
                 </form>
                 </td>
                 <td>'.$listdata->ip.'</td>
                 <td>'.$listdata->os.'</td>
