<?php 
	...
	include('lock.php'); 
	include('config.php');  
	include('include/rummy-dash-deal-free.php');
//	$query = "select * from player_table where game='Free Game' AND game_type='Deal Rummy' ORDER BY table_id DESC";
			...
			<div class="row">
					<div class="col-xs-12">
						...
						<div class="box-footer with-border" style="text-align:right;">
						    ...
						    <a href="dash-deal-free-rummy.php" class="btn btn-danger">Cancel</a>
						</div>
					...
					<div class="col-xs-12">
						<div class="box point-lobby-wrapper">
							<div class="box-body table-responsive">
							     <div class="box-header with-border">
							         <div class="col-md-8">
								        <h3 class="box-title">Free Deal Rummy List ( Total Records : <?php echo numberofdata($conn,$joker,$players,$bet,$status);?>)</h3>
								    </div>
								     <div class="col-md-4" style="text-align: right; margin-top: -9px;">
								         <form method="get" action="excel-dash-deal-free-rummy.php">
										...
										<!--<tr>
											...
											<td>-->
												...
												<!--	<a href="#"> 
													...
													<a href="table_action.php?live=<?php //echo $row['table_id']; ?>&page=dash-deal-free-rummy.php">
													<button class="btn btn-success">Live</button>
												</a>-->
												<?php //}else{ ?>
											<!--	<a href="table_action.php?stop=<?php //echo $row['table_id']; ?>&page=dash-deal-free-rummy.php"> 
