			...
			<div class="content-wrapper">
				...
				<section class="content">
				    <div class="box-header with-border">
								<h3 class="box-title">Sent SMS Details</h3><a href="smstoplayerlist.php" class="btn btn-primary" style="margin-left:10px;">View List</a>
							</div>
					<div class="row">
						...
						<div class="col-md-12  col-xs-12">
							<div class="box-header with-border">
								<h3 class="box-title">Send Sms</h3><!--<a href="listpromotion.php" class="btn btn-primary" style="margin-left:10px;">Promotions List</a>-->
							</div>
							<div class="box">
								<!-- /.box-header -->
								<div class="box-body">
									<form role="form"  method="post" enctype="multipart/form-data">
										...
										<div class="col-md-12 col-xs-12">	
                                      	  <div class="form-group">
												<label style="width:30%">Player</label><br />
											...
											<p style="color:blue;display:none;" id="mactive">Note : This sms sending to all Player which are Active between selected dates</p>
											<p style="color:blue;display:none;" id="mverified">Note : This sms sending to all Player  which are  verified kyc document</p>
											<p style="color:blue;display:none;" id="malluser">Note : This sms sending to all Player which are registered in application</p>
												<p style="color:blue;display:none;" id="mind">Note : This sms sending to Selected Username</p>
											</div>
                                      	...
                                      	<div class="form-group">
											...
											<textarea required id="msg" class="form-control"   name="message"><?php //echo $description;?></textarea>
											</div>
                                        ...
                                        <?php  if($count  != 0) { ?>
                                          ...
                                          <p><span style="background: green;padding: 5px;color: white;">Total <?php echo $count;?> SMS Send Successfully</span></p>
                                        <?php } ?>
...
$(function(){
	   ...
	   //  $('#loaddiv').show();
          ...
          var dataString ='smstemplate='+tempid;
              //  alert(dataString);
                $.ajax({
...
<script type="text/javascript">
              $(document).ready(function() {
                ...
                jQuery(".typeahead1").typeahead({
                  ...
                  displayKey: 'name',
                  source: function (query, process) {
                    return $.get('ajaxpro.php', { smstemplate: query }, function (data) {
                      data = $.parseJSON(data);
                      return process(data);
                    });
                  },
