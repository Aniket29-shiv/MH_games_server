									...
									<form role="form"  method="post" enctype="multipart/form-data">
										...
										<div class="col-md-12 col-xs-12">	
                                      	<div class="form-group">
												...
												<input type="text" name="first_name" value="<?php echo $first_name;?>" Placeholder="First name"  id="table_name" style="padding:5px 0px; width:49%">
												<input type="text" name="middle_name" value="<?php echo $middle_name;?>" Placeholder="Middal name"  id="table_name" style="padding:5px 0px; width:49%">
                                      	...
                                      	<div class="form-group">
												 ...
												 <input type="text" name="last_name" value="<?php echo $last_name;?>" Placeholder="Last name"   id="table_name" style="padding:5px 0px; width:49%">
                                                <input type="text" name="mobile_no" value="<?php echo $mobile_no;?>" Placeholder="Mobile Number"  id="table_name" style="padding:5px 0px; width:49%">
											</div>
											</div>
                                      	...
                                      	<div class="form-group">
												...
												<input type="text" name="email" value="<?php echo $email;?>" Placeholder="Email ID"  id="table_name" style="padding:5px 0px; width:49%">
												<input type="text" name="username" value="<?php echo $username;?>" Placeholder="User Name"  id="table_name" style="padding:5px 0px; width:49%">
											</div>
											</div>
											<div class="col-md-12 col-xs-12">	
                                      	<div class="form-group">
												<label style="width:30%">Address</label><br />
											<textarea class="form-control" name="address" style="width:98%"><?php echo $address;?></textarea>
											</div>
											</div>
                                                    ...
                                                    <select name="state"=""  style="padding:7px; width:49%">
                                                    ...
                                                    <input type="text" name="city" value="<?php echo $city;?>" Placeholder="City"  id="table_name" style="padding:5px 0px; width:49%">
                                                    ...
                                                    <input type="text" name="pincode" value="<?php echo $pincode;?>" Placeholder="Pincode"   id="table_name" style="padding:5px 0px; width:49%">
