...
function Table(tournamentId, tableID) {
	this.id = tableID;
	...
	/****** for SIX player game ******/
	this.six_player_timer_array = [5, 20, 45];
	this.six_usernames = [];
	this.six_user_click = [];
...
Table.prototype.getPlayerIdxFromName = function (player_name) {
	for (var i = 0; i < this.players.length; i++) {
